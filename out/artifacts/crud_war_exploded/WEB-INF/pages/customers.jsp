...
<c:url var="searchAction" value="/customers/search"/>
<form:form action="${searchAction}" commandName="customer" cssClass="elegant-aero">
    <%@include file="/resources/main_theme/jsp/search-customer-form.jsp"%>
</form:form>

<form:form cssClass="tg">
    <%@include file="/resources/main_theme/jsp/list-customers-table.jsp"%>
</form:form>

<br>
<c:url var="addAction" value="/customers/add"/>
<form:form action="${addAction}" commandName="customer" cssClass="elegant-aero">
    <%@include file="/resources/main_theme/jsp/add-customer-form.jsp"%>
</form:form>
